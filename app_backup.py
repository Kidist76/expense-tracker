...
def add_debt():
    ...
    if debt_type == 'owed_to_me':
        flash(f'✅ {request.form.get("person_name")} owes you ETB {request.form.get("amount")}!', 'success')
    else:
        flash(f'✅ You owe {request.form.get("person_name")} ETB {request.form.get("amount")}!', 'success')
